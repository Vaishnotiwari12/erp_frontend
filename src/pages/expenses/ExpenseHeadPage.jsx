  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <StatCard label="Active" value={stats.active} icon={Receipt} accent="success" />
        <StatCard label="Inactive" value={stats.inactive} icon={Receipt} accent="destructive" />
      </div>
      ...
      <DeleteDialog
        ...
        onConfirm={() => deleteExpenseHead(deleteRow._id)}
      />
    </div>
  )
}
