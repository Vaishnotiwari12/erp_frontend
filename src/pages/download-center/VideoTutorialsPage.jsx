      ...
      cell: ({ row }) => (
        <button className="flex items-center gap-3 text-left" onClick={() => setViewRow(row.original)}>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground">{row.original.category} · {row.original.duration}</span>
          </div>
        </button>
      ),
    },
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard label="Total Contents" value={stats.total_contents ?? 0} icon={Video} accent="chart2" />
        <StatCard label="Total Shares" value={stats.total_shares ?? 0} icon={Video} accent="chart3" />
        <StatCard label="Content Types" value={stats.total_types ?? 0} icon={Video} accent="chart4" />
      </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 rounded-xl border bg-muted/30 p-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">{viewRow.category} · {viewRow.duration}</p>
              </div>
        ...
        <FormSection columns={1}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input value={form.duration} onChange={(e) => set('duration', e.target.value)} placeholder="e.g. 15:30" />
            </div>
          </div>
          <div className="space-y-1.5">
