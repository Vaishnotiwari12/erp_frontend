  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard label="Active Types" value={stats.active_types ?? 0} icon={FolderOpen} accent="success" />
        <StatCard label="Total Contents" value={stats.total_contents ?? 0} icon={FolderOpen} accent="chart2" />
        <StatCard label="Total Videos" value={stats.total_videos ?? 0} icon={FolderOpen} accent="chart3" />
      </div>
      ...
      <form onSubmit={(e) => { e.preventDefault(); onSubmit(form) }} className="space-y-4">
        <FormSection columns={1}>
          ...
          <div className="space-y-1.5">
            ...
            <textarea value={form.description} onChange={(e) => set('description', e.target.value)} placeholder="Category description" rows={3}
