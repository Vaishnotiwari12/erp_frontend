...
//
// Purpose:
// Track hostel fee payments, dues, and payment history.
//
// Data Source:
// hostel.service.js
//
...
export default function HostelFeesPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <Breadcrumbs items={[{ label: 'Home', to: '/dashboard' }, { label: 'Hostel' }, { label: 'Hostel Fees' }]} />
      <PageHeader
        title="Hostel Fees"
        description="Track hostel fee payments, dues, and payment history."
        icon={DollarSign}
      />
      ...
      <FilterBar>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <ExportButtons rows={rows} columns={EXPORT_COLS} filename="hostel-fees" />
      ...
      {isLoading ? (
        ...
        <NoData title="No fee records found" description="Hostel fee records will appear here." />
      ) : (
        <DataTable
          columns={columns}
          data={rows}
...
function CollectPaymentDrawer({ open, onOpenChange, fee, onSubmit }) {
  ...
  return (
    <Drawer
      ...
      title="Collect Hostel Fee Payment"
