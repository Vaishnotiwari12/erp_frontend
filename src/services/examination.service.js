// Examinations service. Mock JSON stored here; later replace with Axios calls.
// Backend endpoints (planned):
//   GET    /api/exam/group            -> exam groups
//   GET    /api/exam/schedule         -> exam schedule
//   GET    /api/exam/result           -> exam results
//   GET    /api/exam/marks-grade      -> marks grades
//   GET    /api/exam/marks-division   -> marks divisions
//   GET    /api/exam/admit-card       -> admit card design + print data
//   GET    /api/exam/marksheet         -> marksheet design + print data
